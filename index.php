...
<body>
    ...
    <div class="kotakgambar">
        <div class="thumbnail">
            ...
            <p>Hello everyone, I am a young man who is in his first semester of college majoring in Information
                Technology. I decided to create this personal blog to share my experiences and achievements while
                studying in college. Here, you will find various articles about my college life, including assignments,
                projects, and other activities that I do. Apart from that, I will also share tips and tricks that I have
                applied during my studies. Thank you for visiting my blog, I hope the writings that I present can be
                useful for those of you who are currently in college or just want to know more about college life.</p>
        </div>
    </div>
    ...
    <div class="container2">
        <div class="content2">
            If you like writing and want to share your knowledge, experiences or hobbies with others, why not create a
            blog? By having a blog, you can express yourself and share what you love with others online. Apart from
            that, blogging can also be a fun way to develop writing and communication skills. Let's start creating your
            blog right now!
        </div>
    </div>
